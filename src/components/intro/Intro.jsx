...
function Intro({ onComplete }) {
  ...
  const startExperience = () => {
    ...
    setTimeout(() => setStage(1), 150);   // Razorpay
    setTimeout(() => setStage(2), 1500);  // Stardust
    setTimeout(() => setStage(3), 2800);  // Apex
    setTimeout(() => setStage(4), 4000);  // Online

    // Finish at exactly 5 seconds
    setTimeout(() => {
      if (onComplete) {
        onComplete();
      }
